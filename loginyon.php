...
<html lang="en">
  <head>
    ...
    <style>
      body {
      background-color:rgb(238, 172, 197);
      } 
    </style>
  </head>
  <body>
    ...
    <div class="hakkimda">
			...
			<?php 
				...
				if (($_POST["kullaniciadi"] == $kulad) and ($_POST["kullanicisifre"] == $kulsif))
				{
			    $_SESSION["login"] = "true";
			    $_SESSION["kulad"] = $kulad;
			    $_SESSION["kulsif"] = $kulsif;
			
			    echo("Hoşgeldiniz g201210082!");
			
				}
			
				else 
				{
			    echo "Girilen Kullanıcı Adı veya Şifre Yanlış, 5 Saniye İçinde Tekrar Login Sayfasına Yönlendirileceksiniz.";
